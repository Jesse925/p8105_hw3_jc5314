...
400,000 at the most of day. On some days, the daily activity values were
relatively low, which were around 100,000. On the Saturdays in both week
4 & 5, the daily activity values were only 1440, which may indicate that
either the patient forgot to wear the accelerometer or there were some
situations happend on the patient’s body.
...
similar in most of the day, and the peaks of the activity values during
